...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, AIN_1_Pin|AIN_2_Pin|BIN_1_Pin|BIN_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : car_stby_Pin LD2_Pin */
  GPIO_InitStruct.Pin = car_stby_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : AIN_1_Pin AIN_2_Pin BIN_1_Pin BIN_2_Pin */
