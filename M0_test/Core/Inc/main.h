...
#define color_1_GPIO_Port GPIOA
#define color_2_Pin GPIO_PIN_7
#define color_2_GPIO_Port GPIOA
#define led_5_Pin GPIO_PIN_12
#define led_5_GPIO_Port GPIOB
#define led_6_Pin GPIO_PIN_13
#define led_6_GPIO_Port GPIOB
#define color_3_Pin GPIO_PIN_8
#define color_3_GPIO_Port GPIOA
